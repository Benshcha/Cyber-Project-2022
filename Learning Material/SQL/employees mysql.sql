...
INSERT INTO `employees` VALUES (145,'John','Russell','JRUSSEL','011.44.1344.429268','1987-08-01','SA_MAN',14000,0.4,100,80,NULL);
INSERT INTO `employees` VALUES (146,'Karen','Partners','KPARTNER','011.44.1344.467268','1987-08-02','SA_MAN',13500,0.3,100,80,NULL);
INSERT INTO `employees` VALUES (147,'Alberto','Errazuriz','AERRAZUR','011.44.1344.429278','1987-08-03','SA_MAN',12000,0.3,100,80,NULL);
INSERT INTO `employees` VALUES (148,'Gerald','Cambrault','GCAMBRAU','011.44.1344.619268','1987-08-04','SA_MAN',11000,0.3,100,80,NULL);
INSERT INTO `employees` VALUES (149,'Eleni','Zlotkey','EZLOTKEY','011.44.1344.429018','1987-08-05','SA_MAN',10500,0.2,100,80,NULL);
INSERT INTO `employees` VALUES (150,'Peter','Tucker','PTUCKER','011.44.1344.129268','1987-08-06','SA_REP',10000,0.3,145,80,NULL);
...
INSERT INTO `employees` VALUES (153,'Christopher','Olsen','COLSEN','011.44.1344.498718','1987-08-09','SA_REP',8000,0.2,145,80,NULL);
INSERT INTO `employees` VALUES (154,'Nanette','Cambrault','NCAMBRAU','011.44.1344.987668','1987-08-10','SA_REP',7500,0.2,145,80,NULL);
INSERT INTO `employees` VALUES (155,'Oliver','Tuvault','OTUVAULT','011.44.1344.486508','1987-08-11','SA_REP',7000,0.15,145,80,NULL);
INSERT INTO `employees` VALUES (156,'Janette','King','JKING','011.44.1345.429268','1987-08-12','SA_REP',10000,0.35,146,80,NULL);
INSERT INTO `employees` VALUES (157,'Patrick','Sully','PSULLY','011.44.1345.929268','1987-08-13','SA_REP',9500,0.35,146,80,NULL);
INSERT INTO `employees` VALUES (158,'Allan','McEwen','AMCEWEN','011.44.1345.829268','1987-08-14','SA_REP',9000,0.35,146,80,NULL);
INSERT INTO `employees` VALUES (159,'Lindsey','Smith','LSMITH','011.44.1345.729268','1987-08-15','SA_REP',8000,0.3,146,80,NULL);
INSERT INTO `employees` VALUES (160,'Louise','Doran','LDORAN','011.44.1345.629268','1987-08-16','SA_REP',7500,0.3,146,80,NULL);
...
INSERT INTO `employees` VALUES (163,'Danielle','Greene','DGREENE','011.44.1346.229268','1987-08-19','SA_REP',9500,0.15,147,80,NULL);
INSERT INTO `employees` VALUES (164,'Mattea','Marvins','MMARVINS','011.44.1346.329268','1987-08-20','SA_REP',7200,0.1,147,80,NULL);
INSERT INTO `employees` VALUES (165,'David','Lee','DLEE','011.44.1346.529268','1987-08-21','SA_REP',6800,0.1,147,80,NULL);
INSERT INTO `employees` VALUES (166,'Sundar','Ande','SANDE','011.44.1346.629268','1987-08-22','SA_REP',6400,0.1,147,80,NULL);
INSERT INTO `employees` VALUES (167,'Amit','Banda','ABANDA','011.44.1346.729268','1987-08-23','SA_REP',6200,0.1,147,80,NULL);
INSERT INTO `employees` VALUES (168,'Lisa','Ozer','LOZER','011.44.1343.929268','1987-08-24','SA_REP',11500,0.25,148,80,NULL);
INSERT INTO `employees` VALUES (169,'Harrison','Bloom','HBLOOM','011.44.1343.829268','1987-08-25','SA_REP',10000,0.2,148,80,NULL);
INSERT INTO `employees` VALUES (170,'Tayler','Fox','TFOX','011.44.1343.729268','1987-08-26','SA_REP',9600,0.2,148,80,NULL);
INSERT INTO `employees` VALUES (171,'William','Smith','WSMITH','011.44.1343.629268','1987-08-27','SA_REP',7400,0.15,148,80,NULL);
INSERT INTO `employees` VALUES (172,'Elizabeth','Bates','EBATES','011.44.1343.529268','1987-08-28','SA_REP',7300,0.15,148,80,NULL);
INSERT INTO `employees` VALUES (173,'Sundita','Kumar','SKUMAR','011.44.1343.329268','1987-08-29','SA_REP',6100,0.1,148,80,NULL);
INSERT INTO `employees` VALUES (174,'Ellen','Abel','EABEL','011.44.1644.429267','1987-08-30','SA_REP',11000,0.3,149,80,NULL);
INSERT INTO `employees` VALUES (175,'Alyssa','Hutton','AHUTTON','011.44.1644.429266','1987-08-31','SA_REP',8800,0.25,149,80,NULL);
INSERT INTO `employees` VALUES (176,'Jonathon','Taylor','JTAYLOR','011.44.1644.429265','1987-09-01','SA_REP',8600,0.2,149,80,NULL);
INSERT INTO `employees` VALUES (177,'Jack','Livingston','JLIVINGS','011.44.1644.429264','1987-09-02','SA_REP',8400,0.2,149,80,NULL);
INSERT INTO `employees` VALUES (178,'Kimberely','Grant','KGRANT','011.44.1644.429263','1987-09-03','SA_REP',7000,0.15,149,0,NULL);
INSERT INTO `employees` VALUES (179,'Charles','Johnson','CJOHNSON','011.44.1644.429262','1987-09-04','SA_REP',6200,0.1,149,80,NULL);
